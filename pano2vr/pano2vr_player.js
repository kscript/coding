...
function pano2vrPlayer(g) {
    ...
    function Ea() {
        ...
        if (0 < R) {
            if (2 == R) for (c = 0; c < G.length; c++) a = G[c], "poly" == a.type && a.k != a.c && (a.k > a.c ? (a.c += 0.05, a.k < a.c && (a.c = a.k)) : (a.c -= 0.05, a.k > a.c && (a.c = a.k)), d.dirty = m);
    ...
    function xb() {
        var a = {
            ...
            c = F;
        if (c.offsetParent) {
            do a.x += c.offsetLeft, a.y += c.offsetTop;
    ...
    d.updatePanorama = function() {
        ...
        for (g = 0; g < G.length; g++) {
            ...
            if ("poly" == f.type) {
                ...
                h = mb(h, Lc);
                l = h = mb(h, Mc);
                if (0 < l.length) for (b = 0; b < l.length; b++) a = l[b], 0.1 > a.a ? (k = -c / a.a, h = A / 2 + a.x * k, k = z / 2 + a.y * k) : k = h = 0, a.D = h, a.q = k;
                f.p = l
            }
        }
        ...
        if ($a) {
            ...
            else for (c = 0; 6 > c; c++) if (g = d.cubeFaces[c]) f = "translate3d(" + A / 2 + "px," + z / 2 + "px," + a + "px) ", f += "rotateX(" + Number(p).toFixed(10) + "deg)  rotateY(" + Number(-q).toFixed(10) + "deg) ", g.Y && (f += g.Y, g.style.transform = f)
        }
        Eb()
    };
    var E;
    ...
    d.stopSound = function(a) {
        if ("_main" == a) {
            for (a = 0; a < r.length; a++) r[a].obj.pause(), r[a].obj.currentTime = 0;
    ...
    d.U = function(a) {
        ...
        d.removePanorama();
        d.T = 0;
        for (var a = a.firstChild, c, b, h, g = 1E6; a;) {
            if ("view" == a.nodeName) {
            ...
            if (h) for (c = 0; 6 > c; c++) b = h.getAttributeNode("prev" + c + "url"), ta[c] = b ? new String(b.nodeValue) : "";
    ...
    d.openNext = function(a, c) {
        ...
        if ("{" == a.charAt(0)) if (e = a.substr(1, a.length - 2), Za[e]) d.U(Za[e]), o(a);
        else {
            $("invalid node id: " + e);
            return
